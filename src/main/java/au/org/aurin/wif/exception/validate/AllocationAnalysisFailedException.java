...
public class AllocationAnalysisFailedException extends Exception {
   ...
   */
  public AllocationAnalysisFailedException() {
  }
   ...
   */
  public AllocationAnalysisFailedException(String message) {
    super(message);
  }
   ...
   */
  public AllocationAnalysisFailedException(Throwable cause) {
    super(cause);
  }
   ...
   * @param cause the cause
   */
  public AllocationAnalysisFailedException(String message, Throwable cause) {
    super(message, cause);
  }
